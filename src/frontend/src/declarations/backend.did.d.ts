...
export interface _SERVICE {
  ...
  'addPhoto' : ActorMethod<
    [SessionToken, ExternalBlob, string, [] | [string]],
    bigint
  >,
  'adminLogin' : ActorMethod<[string, string], SessionToken>,
  'adminLogout' : ActorMethod<[SessionToken], undefined>,
  'assignCallerUserRole' : ActorMethod<[Principal, UserRole], undefined>,
  'deletePhoto' : ActorMethod<[SessionToken, bigint], undefined>,
