...
export const idlService = IDL.Service({
  ...
  'addPhoto' : IDL.Func(
      [SessionToken, ExternalBlob, IDL.Text, IDL.Opt(IDL.Text)],
      [IDL.Nat],
      [],
    ),
  'adminLogin' : IDL.Func([IDL.Text, IDL.Text], [SessionToken], []),
  'adminLogout' : IDL.Func([SessionToken], [], []),
  'assignCallerUserRole' : IDL.Func([IDL.Principal, UserRole], [], []),
  'deletePhoto' : IDL.Func([SessionToken, IDL.Nat], [], []),
