...
export class Backend implements backendInterface {
    ...
    async addPhoto(arg0: SessionToken, arg1: ExternalBlob, arg2: string, arg3: string | null): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addPhoto(arg0, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg1), arg2, to_candid_opt_n9(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async adminLogin(arg0: string, arg1: string): Promise<SessionToken> {
        if (this.processError) {
            try {
    ...
    async adminLogout(arg0: SessionToken): Promise<void> {
        if (this.processError) {
            try {
    ...
    async deletePhoto(arg0: SessionToken, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
...
async function from_candid_opt_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Photo]): Promise<Photo | null> {
...
async function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        title: value.title,
        caption: record_opt_to_undefined(from_candid_opt_n15(_uploadFile, _downloadFile, value.caption)),
